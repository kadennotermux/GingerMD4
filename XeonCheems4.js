...
const latensie = speed() - timestampe
 ...
 │▷ ${global.ownername}
 │▷ DG XEON
 │▷ 𝑨𝑳𝑳 𝑺𝑲𝑬𝑻𝑪𝑯𝒀 𝑩𝑶𝑻 𝑭𝑨𝑵𝑨𝑻𝑰𝑪𝑺
 │ Click Buttons Below To use Me 👇🏾
 ╰──────✤2022✤──────────`
...
mediaType:1,
mediaUrl: 'https://telegra.ph/file/97ad903ba5a233f75a751.jpg',
sourceUrl: "https://telegra.ph/file/97ad903ba5a233f75a751.jpg"
}}
}
XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 OWNER 」	
│🚀 ${prefix}self
│🚀 ${prefix}public
│🚀 ${prefix}antitag
...
│🚀 ${prefix}request
│🚀 ${prefix}report [bug]
╰─═════════════⬢Gin⬢` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "YouTube 📍","url": `${websitex}`}},{"urlButton": {"displayText": "Script🔖","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Donate 🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner 👤","id": 'owner'}}] )
break
case 'ownermenu':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 GROUP 」	
│🚀${prefix}groupsetting
│🚀${prefix}grouplink
│🚀${prefix}ephemeral [option]
│🚀${prefix}setgcpp [image]
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 RPG 」	
│🚀${prefix}hunt
│🚀${prefix}mine
│🚀${prefix}fish
│🚀${prefix}heal
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 MAKER 」	
│🚀${prefix}candy
│🚀${prefix}8bit
│🚀${prefix}horror
│🚀${prefix}hoorror
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 DOWNLOAD 」	
│🚀${prefix}instagram [url]
│🚀${prefix}igtv [url]
│🚀${prefix}igstory [username]
│🚀${prefix}facebook [url]
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 SEARCH 」	
│🚀${prefix}play [query]
│🚀${prefix}song [query]
│🚀${prefix}yts [query]
│🚀${prefix}lyrics [query]
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 CONVERT 」	
│🚀 ${prefix}toimage [reply stick]
│🚀 ${prefix}sticker [reply img|gif]
│🚀 ${prefix}take [reply img|gif|stik]
│🚀 ${prefix}smeme [reply img]
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 RANDOM IMG 」	
│🚀${prefix}coffee
│🚀${prefix}bts
│🚀${prefix}woof
│🚀${prefix}meow
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 EMOTE 」	
│🚀${prefix}instagramemoji
│🚀${prefix}facebookemoji
│🚀${prefix}iphoneemoji
│🚀${prefix}samsungemoji
...
await XeonBotInc.send5ButImg(from, `╭═════⬢Gin⬢「 IMG EFFECT 」	
│🚀${prefix}wanted
│🚀${prefix}blur
│🚀${prefix}framed
│🚀${prefix}gayeffect
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 ANIME 」	
│🚀${prefix}naruto
│🚀${prefix}yaoi
│🚀${prefix}neko2
│🚀${prefix}waifu
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 STICKER 」	
│🚀 ${prefix}patrick
│🚀 ${prefix}emoji
│🚀 ${prefix}emojimix
│🚀 ${prefix}attp
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 ANIME STICKER 」	
│🚀${prefix}loli
│🚀${prefix}bully
│🚀${prefix}cuddle
│🚀${prefix}cry
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 NSFW 」	
│🚀${prefix}hentaivideo
│🚀${prefix}yuri
│🚀${prefix}masturbation
│🚀${prefix}thighs
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 Fun 」	
│🚀 ${prefix}how [text
│🚀 ${prefix}when [text]
│🚀 ${prefix}where [text]
│🚀 ${prefix}is [text]
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 Sound 」	
│🚀 ${prefix}sound1
│🚀 ${prefix}sound2
│🚀 ${prefix}sound3
│🚀 ${prefix}sound4
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 GAME 」	
│🚀 ${prefix}truth
│🚀 ${prefix}dare
│🚀 ${prefix}tictactoe
│🚀 ${prefix}delttt
...
await XeonBotInc.send5ButImg(from, `╭═══⬢Gin⬢「 ANONYMOUS 」	
│🚀${prefix}anonymous
│🚀${prefix}start
│🚀${prefix}next
│🚀${prefix}leave
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 TOOL 」	
│🚀 ${prefix}translate [text]
│🚀 ${prefix}fliptext [text]
│🚀 ${prefix}toletter [number]
╰─═════════════⬢Gin⬢` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "YouTube 📍","url": `${websitex}`}},{"urlButton": {"displayText": "Script🔖","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Donate 🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner 👤","id": 'owner'}}] )
...
await XeonBotInc.send5ButImg(from, `╭═══⬢Gin⬢「 DATABASE 」	
│🚀 ${prefix}setcmd
│🚀 ${prefix}listcmd
│🚀 ${prefix}delcmd
│🚀 ${prefix}lockcmd
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 INDO 」	
│🚀 ${prefix}darkjoke
│🚀 ${prefix}quotes
│🚀 ${prefix}animequotes
│🚀${prefix}jalantikus-meme
...
await XeonBotInc.send5ButImg(from, `╭═⬢Gin⬢「 INDO HOROSCOPE 」	
│🚀${prefix}nomorhoki
│🚀${prefix}artimimpi 
│🚀${prefix}artinama 
│🚀${prefix}ramaljodoh 
...
await XeonBotInc.send5ButImg(from, `╭═══════⬢Gin⬢「 OTHER 」	
│🚀 ${prefix}afk
│🚀 ${prefix}readmore [text]
│🚀 ${prefix}toviewonce
│🚀 ${prefix}chatinfo
